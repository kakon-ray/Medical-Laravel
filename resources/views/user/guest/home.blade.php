          ...
          >
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img
                  src="{{asset('guest/img/surgery-1822458.jpg')}}"
              ...
              <div class="carousel-item">
                <img
                  src="{{asset('guest/img/successful-medical-team_329181-9252.jpg')}}"
                  class="d-block w-100 img-fluid"
                  alt="..."
                />
                <div class="carousel-caption d-none d-md-block h3 bounce-top">
              ...
              <div class="carousel-item">
                <img
                  src="{{asset('guest/img/laboratory-ga7286734d_1920.jpg')}}"
                  class="d-block w-100 img-fluid"
                  alt="..."
                />
                <div class="carousel-caption d-none d-md-block h3 bounce-top">
        ...
        <div class="container">
          ...
          <div class="row g-5">
            <article class="col-lg-3 col-md-6">
              <div class="img-hover">
                 <img src="{{asset('guest/img/Screenshot_1.png')}}" alt="Doctor" class="image">
                <div class="overlay">
                  <div class="text ">
            ...
            <article class="col-lg-3 col-md-6">
              <div class="img-hover">
                 <img src="{{asset('guest/img/Screenshot_2.png')}}" alt="Doctor" class="image">
                <div class="overlay">
                  <div class="text ">
                      <a href="#"><i class="fab fa-facebook-square"></i></a>
                      <a href="#"> <i class="fab fa-google-plus-square"></i></a>
            ...
            <article class="col-lg-3 col-md-6">
              <div class="img-hover">
                 <img src="{{asset('guest/img/Screenshot_3.png')}}" alt="Doctor" class="image">
                <div class="overlay">
                  <div class="text ">
                      <a href="#"><i class="fab fa-facebook-square"></i></a>
                      <a href="#"> <i class="fab fa-google-plus-square"></i></a>
            ...
            <article class="col-lg-3 col-md-6">
              <div class="img-hover">
                 <img src="{{asset('guest/img/Screenshot_4.png')}}" alt="Doctor" class="image">
                <div class="overlay">
                  <div class="text ">
                      <a href="#"><i class="fab fa-facebook-square "></i></a>
                      <a href="#"> <i class="fab fa-google-plus-square"></i></a>
        ...
        <div class="container">
          ...
          <div class="row g-4">
            ...
            <div class="img-container">
              <img src="{{asset('guest/img/Screenshot_5.png')}}" alt="Avatar" class="image">
              <div class="overlay ">
                <div class="text ">
            ...
            <article class="col-lg-4 col-md-12">
            <div class="img-container">
              <img src="{{asset('guest/img/Screenshot_6.png')}}" alt="Avatar" class="image">
              <div class="overlay ">
                <div class="text ">
                  <h5 class="pt-3 my-0">Working in the OR as a nurch</h5>
                  <p>Oxygenna , July 29 20211</p>
            ...
            <article class="col-lg-4 col-md-12">
            <div class="img-container">
              <img src="{{asset('guest/img/Screenshot_7.png')}}" alt="Avatar" class="image">
              <div class="overlay ">
                <div class="text ">
                  <h5 class="pt-3 my-0">Working in the OR as a nurch</h5>
                  <p>Oxygenna , July 29 20211</p>
